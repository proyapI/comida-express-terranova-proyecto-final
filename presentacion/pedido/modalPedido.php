...
if($_SESSION["rol"] == "cliente" || $_SESSION["rol"] == "domiciliario"){    
    ...
    $pedido = new Pedido();
    $pedidos = $pedido -> consultarF($_GET["idPedido"],$_GET["idCliente"],$prod,$domiciliario);
    ?>
    ...
    <div class="modal-body">     	
    	...
    	<br><b> <?php echo "Valor por unidad: " ?> </b> <?php  foreach ($pedidos as $p){ echo  $p -> getValor_unidad();} ?>
    </div>    
